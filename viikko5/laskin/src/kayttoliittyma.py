...
class Operaatio:
    ...
    def _kumoa(self):
        if self._historia != []:
            self._logiikka.aseta_arvo(self._historia.pop())


class Summa(Operaatio):
    def __init__(self, logiikka, lue_syote) -> None:
        super().__init__(logiikka, lue_syote)

    def suorita(self):
        self._historia.append(self._logiikka.arvo())
...
class Kayttoliittyma:
    def __init__(self, sovelluslogiikka, root):
        ...
        self._komennot = {
            ...
            Komento.KUMOA: Kumoa(
                sovelluslogiikka, self._lue_syote
            ),  # ei ehkä tarvita täällä...
        }
